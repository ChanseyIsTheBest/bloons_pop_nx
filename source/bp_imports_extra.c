/* bp_imports_extra.c -- the MediaNDK / AImageReader / ALooper import surface.
...
DynLibFunction bp_imports_extra[] = {
...
size_t bp_imports_extra_num =
    sizeof(bp_imports_extra) / sizeof(bp_imports_extra[0]);
