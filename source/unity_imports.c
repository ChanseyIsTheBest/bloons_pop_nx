 ...
 */
#include <stdint.h>
#include "bp_net.h"   /* bpn_inet_ntop */
#include <stddef.h>
#include <math.h>
#include <stdio.h>
#include <stdlib.h>
...
DynLibFunction unity_dynlib_functions[] = {
  ...
  { "inet_addr", (uintptr_t)&bpn_inet_addr },
  { "inet_ntop", (uintptr_t)&bpn_inet_ntop },
